...
@section('TituloPagina','Cliente List')
@section('contenido')
        ...
        <table class="table">
            <thead class="thead-dark">
              <tr>
                ...
                <th scope="col"><ion-icon name="business-outline"></ion-icon> Last Name</th>
                <th scope="col"><ion-icon name="business-outline"></ion-icon> Email</th>
                  <th scope="col"><ion-icon name="business-outline"></ion-icon> DPI</th>
                ...
                <th scope="col"><ion-icon name="browsers-outline"></ion-icon> Tipo de Cliente</th>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td>
                      <form action="{{ route('cliente.edit',$dat->id)}}" method="GET">
                          <button class="btn">
                              <span>
                    ...
                    <td>
                      <form action="{{ route('cliente.show',$dat->id)}}" method="GET">
                            <button class="btn">
